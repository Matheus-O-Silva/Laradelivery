    ...
    <div class="flex flex-row leading-normal border shadow-md rounded-lg max-w-3xl min-w-[50%] bg-white max-h-[96%] min-h-[50%]">
        ...
        <div class="flex flex-col p-4 h-full flex-grow">
            <div class="flex-grow flex flex-col justify-around">
                ...
                <h1 class="font-semibold font-sans text-lg text-red-500 leading-8">R$ {{ $food['price'] }}</h1>
            ...
            <div class="pt-3 flex flex-col flex-grow justify-around">
                <div>
                    <h1 class="font-sans text-sm text-gray-900 leading-8">Quantidade</h1>
                ...
                <button id='addCartBtn' class="p-2 mt-4 bg-blue-600 hover:text-blue-600 text-neutral-50 rounded-md hover:bg-white border-2 border-blue-600 disabled:text-slate-500 disabled:bg-slate-200">Adicionar ao Carrinho</button>
            </div>
        </div>
    </div>
</div>
